...
#All the required JSON files for processing and prediction of crops
data_market = [
  {
    "Crop_Id": 0,
    "Crop": "Rice",
...
#loading the base template of the predict module
def home(request):
 	return render(request,'home/predict.html')

#Returns the result of the prediction of the crop and forwards it to user inputs
def predres(request):
...
#When the farmers selects the the yes option
